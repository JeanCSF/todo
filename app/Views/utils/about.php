...
<div class="container-fluid p-2">
        <div class="about">
            ...
            <div class="text-end">
                <a class="btn btn-outline-secondary" href="https://github.com/JeanCSF/todo" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-github"></i> Repositório</a>
            </div>
        </div>
</div>
