...
<div id="post_div" class="header-post mb-2" style="<?= isset($search) ? 'visibility:hidden;' : '' ?>" tabindex="0">
    <img class="mt-2 rounded-circle border border-light-subtle float-start lazyload" height="48" width="48" data-src="<?= !empty($_SESSION['IMG']) ? base_url('../../assets/img/profile_imgs/' . $_SESSION['USER'] . '/' . $_SESSION['IMG']) : base_url('/assets/avatar.webp') ?>" alt="Profile pic">
